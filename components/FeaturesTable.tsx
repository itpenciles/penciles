...
const featuresData = [
  { feature: 'AI Property Analyses', free: '3 Total', starter: '15 / mo', pro: '100 / mo', team: 'Unlimited' },
  { feature: 'Standard Rental Analysis', free: true, starter: true, pro: true, team: true },
  { feature: 'Property Comparison Tool', free: false, starter: true, pro: true, team: true },
  { feature: 'Wholesale MAO Calculator', free: false, starter: false, pro: true, team: true },
  { feature: 'Subject-To Calculator', free: false, starter: false, pro: true, team: true },
  { feature: 'Seller Financing Calculator', free: false, starter: false, pro: true, team: true },
  { feature: 'Save Properties to Browser', free: true, starter: true, pro: true, team: true },
  { feature: 'Export Data (CSV)', free: false, starter: false, pro: true, team: true },
  { feature: 'Email Support', free: false, starter: true, pro: 'Priority', team: 'Dedicated' },
  { feature: 'Team Collaboration', free: false, starter: false, pro: false, team: 'Coming Soon' },
];
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-x-auto">
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-gray-200">
                {featuresData.map(({ feature, free, starter, pro, team }) => (
                  <tr key={feature}>
