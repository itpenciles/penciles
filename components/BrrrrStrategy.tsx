            ...
            <MathBreakdown
                items={[
                    ...
                    },
                    {
                        ...
                        variant: monthlyCashFlowPostRefi > 0 ? 'green' : 'red',
                        isPercent: false
                    },
                    {
                        label: "CoC Return\nROI",
                        ...
                        variant: isInfiniteReturn || roi > 15 ? 'green' : 'red',
                        isPercent: true
                    },
                    {
                    ...
                    },
                    {
                        ...
                        variant: isInfiniteReturn || (typeof calculateIRR(cashLeftInDeal > 0 ? cashLeftInDeal : 0, monthlyCashFlowPostRefi * 12, brrrr.inputs.arv).irr === 'number' && calculateIRR(cashLeftInDeal > 0 ? cashLeftInDeal : 0, monthlyCashFlowPostRefi * 12, brrrr.inputs.arv).irr >= 10) ? 'green' : 'gray',
                        isPercent: true
                    }
                ]}
